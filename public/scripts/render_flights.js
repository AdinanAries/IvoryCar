                        ...
                        <div class="bubble_popup arrow_on_right_side">
                            ...
                            <div style=" background-color: rgba(0,0,0,0.08); position: relative; padding: 5px 0; margin: 10px; border-left: 10px solid; border-image-source: linear-gradient(orange, orangered, crimson); border-image-slice: 1;">
                                ...
                                <div style="display: flex; flex-direction: column !important; font-size: 12px; margin: 3px 10px; position: relative; z-index: 1;">
                                    ...
                                    <p style="font-size: 11px; color: #194f81; font-weight: bolder;">${current_currency.sign} ${price_metrics_first.toFixed(2)}</p>
                                ...
                                <div style="position: absolute; left: 0; top: 0; height: 100% !important; width: 100% !important;
                                    background-color: rgba(255, 1, 2, 0.6);">
                                    
                                </div>
                                <div style="position: absolute; left: 0; top: 0; height: 60% !important; width: 100% !important; display: flex; flex-direction: column;
                                    justify-content: flex-end; background-color: rgba(255, 255, 255, 0.3);">
                                ...
                                <div style="position: absolute; left: 0; top: 0; height: ${current_price_percentage}% !important; width: 100% !important; display: flex; flex-direction: column;
                                    justify-content: flex-end; background-color: rgba(255, 255, 255, 0.5); border-bottom: 1px solid rgba(21, 142, 222, 0.5);">
                                    <p style="text-align: right; font-weight: bolder; font-size: 11px; margin: 3px 10px; letter-spacing: 1; color: rgba(0,0,0,0.6)">
                                    this price: <span style="font-size: 11px; color: #194f81; padding: 0 !important;">${current_currency.sign} ${each_traveler_price.toFixed(2)}</span></p>
                                </div>
